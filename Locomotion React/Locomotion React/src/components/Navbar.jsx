...
export default function Navbar() {
  ...
  const [avatarErroredFor, setAvatarErroredFor] = useState(null);
  ...
  const hasWorkingAvatar = profileImageUrl && avatarErroredFor !== profileImageUrl;
                  ...
                  >
                    {hasWorkingAvatar ? (
                      <img
                        ...
                        onError={() => setAvatarErroredFor(profileImageUrl)}
                      />
                    ) : (
                      firstLetter
                    )}
