...
# DynamoDB location history configuration
AWS_DYNAMODB_REGION = os.environ.get(
    "AWS_DYNAMODB_REGION",
    os.environ.get("AWS_REGION", "ap-south-1"),
)
DYNAMODB_LOCATION_TABLE = os.environ.get("DYNAMODB_LOCATION_TABLE", "")
LOCATION_HISTORY_ENABLED = _env_bool(
    "LOCATION_HISTORY_ENABLED",
    bool(DYNAMODB_LOCATION_TABLE),
)
LOCATION_HISTORY_TTL_DAYS = _env_int("LOCATION_HISTORY_TTL_DAYS", 180)
LOCATION_HISTORY_SAMPLE_SECONDS = _env_int("LOCATION_HISTORY_SAMPLE_SECONDS", 5)
