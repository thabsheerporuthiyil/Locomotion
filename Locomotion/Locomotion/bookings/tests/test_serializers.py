...
from bookings.serializers import RideRequestCreateSerializer
...
class RideRequestCreateSerializerTest(TestCase):
    ...
    def test_valid_serializer(self):
        ...
        serializer = RideRequestCreateSerializer(data=data)
